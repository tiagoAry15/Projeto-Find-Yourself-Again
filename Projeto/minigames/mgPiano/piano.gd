...
const END_KEY = 108
var quant = 0
const WhiteKeyScene = preload("res://minigames/mgPiano/piano_keys/white_piano_key.tscn")
const BlackKeyScene = preload("res://minigames/mgPiano/piano_keys/black_piano_key.tscn")
